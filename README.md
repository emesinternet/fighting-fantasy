...
- **Focused adventure log:** The log keeps the five most recent updates visible and now pairs emoji with color-coded tones so key actions stay easy to scan.
